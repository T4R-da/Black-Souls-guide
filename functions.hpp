...
void BS1Endings()
{
    ...
    do
    {
        std::cout << "\n\nWhich of these endings do you need help with? ";
        std::cin >> BS1Ending;
        std::cout << std::endl;
...
void BS2Endings()
{
    ...
    do
    {
        ...
        if (BS2Ending == 'A')
        {
            std::cout << "To achieve this ending, defeat Tearing Beast, Dinah and [Make love] to Alice.\n"
                         "After finding the little girl, Grimm will begin to wonder, -Where is Alice?." << std::endl;
        }
        else if (BS2Ending == 'B')
        {
            std::cout << "To achieve this ending, reach Covenant Lv3 for the following heroines: White Rabbit Node, Lizard Bill,\n"
                         "Foolish Bird Dodo, Caterpillar Shisha, Duchess Margaret von Tyrol, Hatta the Hatter, Mock Turtle, Wolris the Walrus\n"
                         "and the Tweedle Twins.\n"
        ...
        {
            std::cout << "Lose against Tearing Beast, Dinah. After witnessing Dinah slaughter the little girl, Grimm will begin to wonder,\n"
                         "-Where is Alice?." << std::endl;
        }
        else if (BS2Ending == 'D')
        {
            std::cout << "Defeat Tearing Beast, Dinah and choose [Kill] while having more than 0 SEN. After brutally killing the\n"
                         "young girl, Grimm will again begin to wonder -Where is Alice?." << std::endl;
        }
        else if (BS2Ending == 'E')
        {
            std::cout << "After defeating Tearing Beast, Dinah choose [Kill] while having 0 SEN or less.\n"
                         "This will start a battle against an opponent depending on the Alice chosen at the start of the cycle:\n"
                         "The Black One if the Daughter was chosen, the Shadow Demoness if the Little Sister was chosen,\n"
                         "and the Elk Goddess if the Mother was chosen instead. Differently from the fight against Dinah,\n"
                         "no ending will be achieved upon defeat and the player will be simply sent to the title screen." << std::endl;
        }
        else if (BS2Ending == 'F')
        {
            std::cout << "Defeat Little Girl Alice after siding with Leaf.\n"
        ...
        {
            std::cout << "Defeat The Crawling Little Girls after siding with Red Hood. After the creator dies, the garden begins to collapse.\n"
                         ...
                         "While running away, Grimm comes across the soul of a confused Alice Liddell, who has escaped the grasp of The Crawling One\n"
                         "after her defeat. Lewis Carroll's soul will detach from Grimm and comfort her, before leaving with the girl.\n"
        ...
        {
            std::cout << "To achieve one of these endings, defeat Grand Guignol.\n"
                         "After the death of the mechanical God, Wonderland begins to crumble. While trying to get out, Grimm makes a leap of faith\n"
                         "and manages to reunite with Red Hood, who catches his hand.\n"
                         "However, the Crawling One grabs onto him while they try to escape. Realizing his nature will doom anyone who approaches him,\n"
                         "he sacrifices himself so Red Hood can live.\n"
                         "He will be slowly consumed by a horde of Alice, losing himself as a result. This is the Hell Ending.\n"
                         "If Prickett's Ring is in the inventory, one Alice, implied to be Prickett herself, will guide him out of the Chaos and\n"
                         "back into reality.\n"
                         "Outside, he will live with Red Hood for the rest of her life. While Leaf finds herself free from her shackles,\n"
                         "Grimm stays by Red's side in her last moments.\n"
        ...
        {
            std::cout << "Lose to The Crawling Little Girls. Defeated, Grimm will lose himself in a miasma of little girls,\n"
                         "forever trapped in a cycle of copulation. Note that you need to have sided with Red Hood to achieve this ending,\n"
                         "as siding with Leaf will result in fighting Little Girl Alice instead." << std::endl;
        }
        else if (BS2Ending == 'V') // UE2
        {
            std::cout << "Pick [Offer my soul] while interacting with Grand Guignol or [Give up] after losing to it.\n"
