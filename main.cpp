...
int main()
{
  for (int i = 0; i < 10; i++)
  {
    ...
    if (game == 1)
    {
      ...
      cout << endl
           << R"([For endings A to E, the player needs to reach a progression level of 10, indicated by the torches lit above 
      the white door in the Library Dream. This will open the doors, leading you to the supposed end of the story.])"
           << endl;
